/* myVector_5.cpp, note this is an "empty project" without the PPP scaffolding
 ...
 - new in this version is a half-way implementation of some iterators for illustration purpose
 - Note that this version of myVector is deliberately still not yet complete, 
	. dynamic size, reserve, resize, push_back and much more is still not included
*/
#include<iostream>
#include<string>
using namespace std;
...
try {
	...
	for (auto e : v4) {
		cout << e << " "; // shows vector not changed
	}
	cout << endl;
